  ...
  <ul class="dropdown-menu pull-right">
      ...
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td class="text-left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
            ...
            <?php } ?></td>
          <td class="text-right number-total">x <?php echo $product['quantity']; ?></td>
        ...
        <tr>
          ...
          <td class="text-right number-total">x&nbsp;1</td>
    ...
    <li>
      <div>
        ...
        <p class="text-right"><a href="<?php echo $cart; ?>"><span class="btn btn-primary"><i class="fa fa-shopping-cart"></i> <?php echo $text_cart; ?></span></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo $checkout; ?>"><span class="btn btn-info"><i class="fa fa-share"></i> <?php echo $text_checkout; ?></span></a></p>
      </div>
    </li>
    <?php } else { ?>
    <li>
