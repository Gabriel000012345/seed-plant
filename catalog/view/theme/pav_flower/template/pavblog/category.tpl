...
<div class="main-columns container space-30">
    <div class="container-inside">
        <div class="row">
            ...
            <?php endif; ?>
            <div class="col-md-<?php echo $SPAN[1];?>">
                <div id="content" class="space-padding-20 bg-white">
                ...
                -->
                    <div class="pav-category">
                                        ...
                                        <div class="children-inner">
                                            <h4>
                                                <a href="<?php echo $sub['link']; ?>"
                                                   title="<?php echo $sub['title']; ?>"><?php echo $sub['title']; ?>
                                                    (<?php echo $sub['count_blogs']; ?>)</a>
                        ...
                        <?php } ?>
                        <div class="pav-blogs">
                            <?php $cols = $cat_columns_leading_blog; ?>
                            <?php
